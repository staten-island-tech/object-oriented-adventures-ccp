...
class shop():
    ...
    def joebiden(tieroftheweapon, nameofweapon, iven, discount):
        if iven[4]['coin']>=helpme2thebetterone[0][tieroftheweapon][nameofweapon]/discount:
            iven[4]['coin']-=(helpme2thebetterone[0][tieroftheweapon][nameofweapon]/discount)
    ...
    def shop(iven, characterstat):
        ...
        if player=="1":
            ...
            for i in helpme[0]:
                ...
                print("price: " + str(helpme[0][i]/characterstat.intellgence))
                for j in data2[0]:
                    for x in data2[0][j]:
                        if x == i:
                            if j=="healing":
            ...
            for i in helpme2thebetterone[0]:
                for j in helpme2thebetterone[0][i]:
                    numberselection+=1
                    print(f"{numberselection},", shop.weaponamedisplay(i, j), helpme2thebetterone[0][i][j]//characterstat.intellgence)
